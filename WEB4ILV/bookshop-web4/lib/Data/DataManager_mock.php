        ...
        switch ($type) {
            ...
            case 'books':
                $data = [
                    ...
                    12 => new Book(12, 2, "Scripting (Attacks) for Beginners - <script type=\"text/javascript\">alert('You got hacked! Too bad, I will be mining bitcoins now ;)');</script>", "John Doe", 9.99),
